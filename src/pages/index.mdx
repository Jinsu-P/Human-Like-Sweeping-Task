...
__user input command: *"Sweep with 4 times"*__
...
__user input command: *"Sweep it little harder"*__
...
__user input command: *"Sweep starting 2cm in front"*__
...
__user input command: *"Sweep 1.5 times faster"*__
